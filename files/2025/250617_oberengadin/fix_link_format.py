...
# Construct Link with GPX (Correct Format)
...
# Correct Swisstopo link format: #/map?center=E,N&z=zoom&...
link = f"https://map.geo.admin.ch/#/map?lang=de&center={E},{N}&z={zoom}&bgLayer=ch.swisstopo.pixelkarte-farbe&topic=ech&layers=KML|{gpx_url}"
